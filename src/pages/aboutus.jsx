...
const Aboutus = () => {
    return (
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col items-center justify-center">
          <h1 className="text-4xl md:text-5xl text-white font-serif tracking-wider mb-4">ABOUT US</h1>
          <div className="w-20 h-1 bg-[#aa8453]"></div>
        </div>
        </div>

            <div className="flex flex-col lg:flex-row bg-[#1b1b1b] p-4 lg:p-10 justify-between h-screen" id="about">
                <div className="w-full lg:w-[48vw] text-white p-3 lg:p-5 font-serif mt-16">
                ...
                <div className="w-full lg:w-[42vw]  flex-col sm:flex-row lg:flex-row gap-4 lg:gap-5 mt-4 hidden sm:flex lg:mt-16 md:mt-0">
