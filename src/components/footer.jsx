            ...
            <div className="container mx-auto px-4 grid md:grid-cols-4 gap-8 font-serif">
                <div>
                    ...
                    <div className="flex space-x-4">
                        <Facebook className="w-5 h-5 text-gray-400 hover:text-[#aa8453] cursor-pointer transition duration-300" />
                        <Instagram  className="w-5 h-5 text-gray-400 hover:text-[#aa8453] cursor-pointer transition duration-300" />
                        <Twitter className="w-5 h-5 text-gray-400 hover:text-[#aa8453] cursor-pointer transition duration-300" />
                    </div>
                </div>
